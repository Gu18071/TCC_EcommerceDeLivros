   ...
   if($old_pass != $empty_pass){
      if($old_pass != $prev_pass){
         ...
         if($new_pass != $empty_pass){
            ...
            $message[] = 'Por favor escreva a nova senha!';
         }
      }
   }  
...
<section class="form-container update-form">
   ...
   <form action="" method="post">
      ...
      <input type="password" name="old_pass" placeholder="Senha antiga" class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="password" name="new_pass" placeholder="Senha nova" class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">

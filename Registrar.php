...
if(isset($_POST['submit'])){
   ...
   if($select_user->rowCount() > 0){
      $message[] = 'Email ou número já existe!';
   }else{
      if($pass != $cpass){
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="name" required placeholder="Nome" class="box" maxlength="50">
      <input type="email" name="email" required placeholder="Email" class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="number" name="number" required placeholder="Número de celular com ddd" class="box" min="0" max="9999999999" maxlength="10">
      ...
      <input type="submit" value="Criar conta" name="submit" class="btn">
      <p>Já tem uma conta? <a href="login.php">Faça o login agora!</a></p>
   </form>
